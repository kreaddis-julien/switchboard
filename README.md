...
- **Configurable toolbar**: choose per action (pin, running, overview, collapse-all, bookmarks, today, archive, re-sort, add-project) whether it sits in the sidebar toolbar or behind the "more" (⋯) popover — Settings → Toolbar.
