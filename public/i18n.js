...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      // Agent Teams (orchestration view)
      'orch.new_run': '+ New run',
      'orch.col.backlog': 'Backlog',
      'orch.col.ready': 'Ready',
      'orch.col.progress': 'In progress',
      'orch.col.running': 'Running',
      'orch.col.review': 'Review',
      'orch.col.merge': 'Merge',
      'orch.col.done': 'Done',
      'orch.col.attention': 'Attention',
      'orch.tab.overview': 'Overview',
      'orch.tab.board': 'Board',
      'orch.tab.plan': 'Plan',
      'orch.tab.timeline': 'Timeline',
      'orch.status.draft': 'draft',
      'orch.status.ready': 'ready',
      'orch.status.spawning': 'spawning',
      'orch.status.in_progress': 'in progress',
      'orch.status.needs_review': 'needs review',
      'orch.status.reviewing': 'reviewing',
      'orch.status.changes_requested': 'changes requested',
      'orch.status.approved': 'approved',
      'orch.status.merging': 'merging',
      'orch.status.done': 'done',
      'orch.status.blocked': 'blocked',
      'orch.status.failed': 'failed',
      'orch.action.mark_ready': 'Mark ready',
      'orch.action.approve_skip': 'Approve (skip review)',
      'orch.action.force_approve': 'Force approve',
      'orch.action.request_changes': 'Request changes',
      'orch.action.mark_done': 'Mark done (skip merge)',
      'orch.action.retry': 'Retry',
      'orch.btn.master': 'Master session',
      'orch.btn.pause': 'Pause',
      'orch.btn.resume': 'Resume',
      'orch.btn.delete': 'Delete',
      'orch.btn.worker': 'Worker',
      'orch.btn.reviewer': 'Reviewer',
      'orch.btn.spec': 'Spec',
      'orch.btn.review': 'Review',
      'orch.open_worker': 'Open the worker session terminal',
      'orch.open_reviewer': 'Open the reviewer session terminal',
      'orch.delete_run': 'Delete run',
      'orch.delete_msg': 'Delete "{title}" and its worktrees, session transcripts and run files? This cannot be undone.',
      'orch.cancel': 'Cancel',
      'orch.empty_runs': 'No Agent Teams runs yet. Start one with "+ New run".',
      'orch.empty_select': 'Select a run from the sidebar, or create a new one.',
      'orch.no_tasks': 'No tasks yet — the master is still planning.',
      'orch.no_plan': 'plan.md has not been written yet.',
      'orch.no_events': 'No events yet.',
      'orch.ov_planning': 'The master is planning — tasks appear after /sb-decompose.',
      'orch.ov_no_tasks': 'No tasks for this run.',
      'orch.tasks_done': '{done}/{total} tasks',
      'orch.tiers_prefix': 'tiers — ',
      'orch.invalid_files': '{n} invalid task file{s}',
      // Agent Teams — new run dialog
      'orch.dlg.title': 'New Agent Teams run',
      'orch.dlg.project': 'Project',
      'orch.dlg.run_title': 'Run title',
      'orch.dlg.title_ph': 'e.g. Auth refactor',
      'orch.dlg.goal': 'Goal',
      'orch.dlg.goal_ph': 'What should be built? The master agent starts from this.',
      'orch.dlg.default_profile': 'Default profile',
      'orch.dlg.master_profile': 'Master profile (planner/orchestrator — strongest model)',
      'orch.dlg.worker_profile': 'Default worker profile (fallback when no tier matches)',
      'orch.dlg.reviewer_profile': 'Default reviewer profile (adversarial review)',
      'orch.dlg.max_workers': 'Max parallel workers (global ceiling across all tiers)',
      'orch.dlg.tiers': 'Model tiers by task complexity (optional — cost control)',
      'orch.dlg.tiers_hint': 'Leave a tier on "Default worker profile" to fall back. Per-tier max caps run within the global ceiling above.',
      'orch.dlg.tier_model': 'Model for {cx} tasks',
      'orch.dlg.tier_max': 'Max parallel {cx} tasks',
      'orch.dlg.isolation': 'Isolation',
      'orch.dlg.iso_worktree': 'Git worktree per task (recommended)',
      'orch.dlg.iso_none': 'Shared working dir (no isolation)',
      'orch.dlg.review_rigor': 'Review rigor',
      'orch.dlg.rev_tiered': 'Tiered by complexity (recommended — more lenses for harder tasks)',
      'orch.dlg.rev_all': 'All lenses every task (spec, functionality, tests, security, style)',
      'orch.dlg.rev_func': 'Single combined review (cheapest)',
      'orch.dlg.rev_disabled': 'No review (auto-approve — not recommended)',
      'orch.dlg.gate': 'Default phase-gate command (optional)',
      'orch.dlg.gate_ph': 'e.g. npm test  (run on the integration branch per phase)',
      'orch.dlg.budget_usd': 'Budget cap — auto-pause at $ (needs provider cost data)',
      'orch.dlg.usd_ph': 'USD (optional)',
      'orch.dlg.budget_tok': 'Budget cap — auto-pause at output tokens',
      'orch.dlg.tok_ph': 'output tokens (optional)',
      'orch.dlg.create': 'Create run & start master',
      'orch.dlg.creating': 'Creating…',
      'orch.dlg.err_no_project': 'No project selected — add a project first.',
      'orch.dlg.err_title': 'Title is required.',
      'orch.dlg.err_goal': 'Goal is required.',
      'orch.dlg.err_create': 'Failed to create run.',
    ...
    fr: {
      ...
      'orch.new_run': '+ Nouveau run',
      'orch.col.backlog': 'À faire',
      'orch.col.ready': 'Prêt',
      'orch.col.progress': 'En cours',
      'orch.col.running': 'En cours',
      'orch.col.review': 'Revue',
      'orch.col.merge': 'Fusion',
      'orch.col.done': 'Terminé',
      'orch.col.attention': 'Attention',
      'orch.tab.overview': 'Aperçu',
      'orch.tab.board': 'Board',
      'orch.tab.plan': 'Plan',
      'orch.tab.timeline': 'Chronologie',
      'orch.status.draft': 'brouillon',
      'orch.status.ready': 'prêt',
      'orch.status.spawning': 'démarrage',
      'orch.status.in_progress': 'en cours',
      'orch.status.needs_review': 'revue requise',
      'orch.status.reviewing': 'en revue',
      'orch.status.changes_requested': 'modifs demandées',
      'orch.status.approved': 'approuvé',
      'orch.status.merging': 'fusion',
      'orch.status.done': 'terminé',
      'orch.status.blocked': 'bloqué',
      'orch.status.failed': 'échoué',
      'orch.action.mark_ready': 'Marquer prêt',
      'orch.action.approve_skip': 'Approuver (sauter la revue)',
      'orch.action.force_approve': "Forcer l'approbation",
      'orch.action.request_changes': 'Demander des modifs',
      'orch.action.mark_done': 'Marquer terminé (sauter la fusion)',
      'orch.action.retry': 'Réessayer',
      'orch.btn.master': 'Session master',
      'orch.btn.pause': 'Pause',
      'orch.btn.resume': 'Reprendre',
      'orch.btn.delete': 'Supprimer',
      'orch.btn.worker': 'Worker',
      'orch.btn.reviewer': 'Reviewer',
      'orch.btn.spec': 'Spec',
      'orch.btn.review': 'Revue',
      'orch.open_worker': 'Ouvrir le terminal de la session worker',
      'orch.open_reviewer': 'Ouvrir le terminal de la session reviewer',
      'orch.delete_run': 'Supprimer le run',
      'orch.delete_msg': 'Supprimer « {title} » ainsi que ses worktrees, transcripts de session et fichiers de run ? Action irréversible.',
      'orch.cancel': 'Annuler',
      'orch.empty_runs': "Aucun run Agent Teams. Démarrez-en un avec « + Nouveau run ».",
      'orch.empty_select': 'Sélectionnez un run dans la barre latérale, ou créez-en un.',
      'orch.no_tasks': 'Aucune tâche pour l’instant — le master planifie encore.',
      'orch.no_plan': "plan.md n’a pas encore été écrit.",
      'orch.no_events': 'Aucun événement pour l’instant.',
      'orch.ov_planning': 'Le master planifie — les tâches apparaîtront après /sb-decompose.',
      'orch.ov_no_tasks': 'Aucune tâche pour ce run.',
      'orch.tasks_done': '{done}/{total} tâches',
      'orch.tiers_prefix': 'tiers — ',
      'orch.invalid_files': '{n} fichier(s) de tâche invalide(s)',
      'orch.dlg.title': 'Nouveau run Agent Teams',
      'orch.dlg.project': 'Projet',
      'orch.dlg.run_title': 'Titre du run',
      'orch.dlg.title_ph': 'ex. Refonte de l’authentification',
      'orch.dlg.goal': 'Objectif',
      'orch.dlg.goal_ph': 'Que faut-il construire ? Le master agent démarre de là.',
      'orch.dlg.default_profile': 'Profil par défaut',
      'orch.dlg.master_profile': 'Profil master (planification/orchestration — modèle le plus fort)',
      'orch.dlg.worker_profile': 'Profil worker par défaut (repli si aucun tier ne correspond)',
      'orch.dlg.reviewer_profile': 'Profil reviewer par défaut (revue adversariale)',
      'orch.dlg.max_workers': 'Workers parallèles max (plafond global tous tiers confondus)',
      'orch.dlg.tiers': 'Tiers de modèles par complexité de tâche (optionnel — contrôle des coûts)',
      'orch.dlg.tiers_hint': 'Laissez un tier sur « Profil worker par défaut » pour le repli. Les plafonds par tier s’appliquent dans la limite globale ci-dessus.',
      'orch.dlg.tier_model': 'Modèle pour les tâches {cx}',
      'orch.dlg.tier_max': 'Tâches {cx} parallèles max',
      'orch.dlg.isolation': 'Isolation',
      'orch.dlg.iso_worktree': 'Worktree git par tâche (recommandé)',
      'orch.dlg.iso_none': 'Répertoire de travail partagé (pas d’isolation)',
      'orch.dlg.review_rigor': 'Rigueur de revue',
      'orch.dlg.rev_tiered': 'Échelonnée par complexité (recommandé — plus de lentilles pour les tâches dures)',
      'orch.dlg.rev_all': 'Toutes les lentilles à chaque tâche (spec, fonctionnalité, tests, sécurité, style)',
      'orch.dlg.rev_func': 'Revue combinée unique (la moins chère)',
      'orch.dlg.rev_disabled': 'Pas de revue (auto-approbation — non recommandé)',
      'orch.dlg.gate': 'Commande de phase-gate par défaut (optionnel)',
      'orch.dlg.gate_ph': 'ex. npm test  (exécuté sur la branche d’intégration à chaque phase)',
      'orch.dlg.budget_usd': 'Plafond budget — pause auto à $ (nécessite les coûts du fournisseur)',
      'orch.dlg.usd_ph': 'USD (optionnel)',
      'orch.dlg.budget_tok': 'Plafond budget — pause auto au nombre de tokens de sortie',
      'orch.dlg.tok_ph': 'tokens de sortie (optionnel)',
      'orch.dlg.create': 'Créer le run & démarrer le master',
      'orch.dlg.creating': 'Création…',
      'orch.dlg.err_no_project': 'Aucun projet sélectionné — ajoutez d’abord un projet.',
      'orch.dlg.err_title': 'Le titre est requis.',
      'orch.dlg.err_goal': 'L’objectif est requis.',
      'orch.dlg.err_create': 'Échec de la création du run.',
